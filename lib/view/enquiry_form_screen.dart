...
class EnquiryFormScreen extends StatefulWidget {
  const EnquiryFormScreen({Key? key}) : super(key: key);
...
class _EnquiryFormScreenState extends State<EnquiryFormScreen> {
  ...
  String? selectedEnquiry = 'Select Enquiry';
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        isDense: true,
                        hintText: 'typeOfEnquiry'.tr,
                      ),
                      // value: selectedEnquiry,
                      items: enquiryList
                          .map((enquiry) => DropdownMenuItem<String>(
                                value: enquiry,
                                child: Text(enquiry,
                          ...
                          .toList(),
                      onChanged: (enquiry) =>
                          setState(() => selectedEnquiry = enquiry),
                      menuMaxHeight: 300,
                    ),
                    SizedBox(
